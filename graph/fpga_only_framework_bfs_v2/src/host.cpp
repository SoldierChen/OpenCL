	...
	)
{
	...
	int argi = 0;
	clSetKernelArgSVMPointerAltera(readActiveVertices, argi++, (void*)blkActiveVertices);	
	clSetKernelArgSVMPointerAltera(readActiveVertices, argi++, (void*)blkActiveVertexNum);
	clSetKernelArgSVMPointerAltera(readActiveVertices, argi++, (void*)fpgaIterNum);

	argi = 0;
	clSetKernelArgSVMPointerAltera(readNgbInfo, argi++, (void*)blkRpa);
	clSetKernelArgSVMPointerAltera(readNgbInfo, argi++, (void*)blkRpaLast);
	clSetKernelArgSVMPointerAltera(readNgbInfo, argi++, (void*)cia_padding);
	//clSetKernelArgSVMPointerAltera(readNgbInfo, argi++, (void*)blkEdgeProp);
	clSetKernelArgSVMPointerAltera(readNgbInfo, argi++, (void*)vertexProp);	// vertexScore - PR
	clSetKernelArgSVMPointerAltera(readNgbInfo, argi++, (void*)blkActiveVertexNum);
	//clSetKernelArgSVMPointerAltera(readNgbInfo, argi++, (void*)blkVertexNum);
	//clSetKernelArgSVMPointerAltera(readNgbInfo, argi++, (void*)blkEdgeNum);
	clSetKernelArgSVMPointerAltera(readNgbInfo, argi++, (void*)srcRange);
	clSetKernelArgSVMPointerAltera(readNgbInfo, argi++, (void*)fpgaIterNum);
	argi = 0;
	//clSetKernelArgSVMPointerAltera(processEdge, argi++, (void*)vertexProp);
	clSetKernelArgSVMPointerAltera(processEdge, argi++, (void*)tmpVertexProp);
	//clSetKernelArgSVMPointerAltera(processEdge, argi++, (void*)eop);
	clSetKernelArgSVMPointerAltera(processEdge, argi++, (void*)fpgaIterNum);
	clSetKernelArgSVMPointerAltera(processEdge, argi++, (void*)srcRange);
	clSetKernelArgSVMPointerAltera(processEdge, argi++, (void*)sinkRange);
	argi = 0;
	clSetKernelArgSVMPointerAltera(vertexApply, argi++, (void*)vertexProp);
	clSetKernelArgSVMPointerAltera(vertexApply, argi++, (void*)tmpVertexProp);
	//clSetKernelArgSVMPointerAltera(vertexApply, argi++, (void*)activeVertices);
	//clSetKernelArgSVMPointerAltera(vertexApply, argi++, (void*)outDeg);
	//clSetKernelArgSVMPointerAltera(vertexApply, argi++, (void*)vertexScore);
	//clSetKernelArgSVMPointerAltera(vertexApply, argi++, (void*)error);
	clSetKernelArg(vertexApply, argi++, sizeof(int), (void*)&vertexNum);
	//clSetKernelArg(vertexApply, argi++, sizeof(int), (void*)&base_score);
	argi = 0;
	clSetKernelArgSVMPointerAltera(activeVertexOutput, argi++, (void*)activeVertices);
	clSetKernelArgSVMPointerAltera(activeVertexOutput, argi++, (void*)error);
}
