...
{	
	...
	while(true){
		...
		if(validData){
			...
			if((srcBufIdx & 0xf) == 0)
				srcProp = vPropBuffer0[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 1)
				srcProp = vPropBuffer1[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 2)
				srcProp = vPropBuffer2[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 3)
				srcProp = vPropBuffer3[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 4)
				srcProp = vPropBuffer4[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 5)
				srcProp = vPropBuffer5[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 6)
				srcProp = vPropBuffer6[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 7)
				srcProp = vPropBuffer7[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 8)
				srcProp = vPropBuffer8[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 9)
				srcProp = vPropBuffer9[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 10)
				srcProp = vPropBuffera[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 11)
				srcProp = vPropBufferb[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 12)
				srcProp = vPropBufferc[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 13)
				srcProp = vPropBufferd[srcBufIdx >> 4];
			else if ((srcBufIdx & 0xf) == 14)
				srcProp = vPropBuffere[srcBufIdx >> 4];
			else 
				srcProp = vPropBufferf[srcBufIdx >> 4];
