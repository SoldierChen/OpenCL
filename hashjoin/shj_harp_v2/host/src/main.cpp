...
int main(int argc, char *argv[]) {
  ...
  unsigned int rTupleNum = 16 * 1024 * 1024/factor;//16318*1024; //16 * 1024 * 1204 ;
	unsigned int sTupleNum = 16 * 1024 * 1024/factor;//16318*1024; //16 * 1024 * 1024;
	unsigned int rHashTableBucketNum = rTupleNum / 4;//4 * 1024 * 1024 / factor; //32*1024; //0x400000; //
	unsigned int hashBucketSize = rTupleNum / rHashTableBucketNum;
	...
	for(int i = 0 ; i < 100; i ++) printf("%d \t", HashTable[2*i]);
