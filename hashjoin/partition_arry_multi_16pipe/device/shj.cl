                      ...
                      )
{
 ...
 //   for(int i = rTableOffset; i < rTableOffset + rTableReadNum; i ++){
    for(int i = 0; i < rTableOffset + rTableReadNum; i ++){
          uint2 rtable_uint2 = rTable[i];
          switch((rtable_uint2.x) & 0xf){
            case 0 :  write_channel_altera(relR[i & 0x7][0], rtable_uint2); break;
            case 1 :  write_channel_altera(relR[i & 0x7][1], rtable_uint2); break;
            case 2 :  write_channel_altera(relR[i & 0x7][2], rtable_uint2); break;
            case 3 :  write_channel_altera(relR[i & 0x7][3], rtable_uint2); break;
            case 4 :  write_channel_altera(relR[i & 0x7][4], rtable_uint2); break;
            case 5 :  write_channel_altera(relR[i & 0x7][5], rtable_uint2); break;
            case 6 :  write_channel_altera(relR[i & 0x7][6], rtable_uint2); break;
            case 7 :  write_channel_altera(relR[i & 0x7][7], rtable_uint2); break;
            case 8 :  write_channel_altera(relR[i & 0x7][8], rtable_uint2); break;
            case 9 :  write_channel_altera(relR[i & 0x7][9], rtable_uint2); break;
            case 10 : write_channel_altera(relR[i & 0x7][10], rtable_uint2); break;
            case 11 : write_channel_altera(relR[i & 0x7][11], rtable_uint2); break;
            case 12 : write_channel_altera(relR[i & 0x7][12], rtable_uint2); break;
            case 13 : write_channel_altera(relR[i & 0x7][13], rtable_uint2); break;
            case 14 : write_channel_altera(relR[i & 0x7][14], rtable_uint2); break;
            case 15 : write_channel_altera(relR[i & 0x7][15], rtable_uint2); break;
          }
      }
  ...
  #pragma unroll 8
    ...
    for(int i = 0; i < (sTableOffset + sTableReadNum); i ++){
          uint2 stable_uint2 = sTable[i];
          switch((stable_uint2.x)& 0xf){
            case 0 :  write_channel_altera(relS[i & 0x7][0], stable_uint2); break;
            case 1 :  write_channel_altera(relS[i & 0x7][1], stable_uint2); break;
            case 2 :  write_channel_altera(relS[i & 0x7][2], stable_uint2); break;
            case 3 :  write_channel_altera(relS[i & 0x7][3], stable_uint2); break;
            case 4 :  write_channel_altera(relS[i & 0x7][4], stable_uint2); break;
            case 5 :  write_channel_altera(relS[i & 0x7][5], stable_uint2); break;
            case 6 :  write_channel_altera(relS[i & 0x7][6], stable_uint2); break;
            case 7 :  write_channel_altera(relS[i & 0x7][7], stable_uint2); break;
            case 8 :  write_channel_altera(relS[i & 0x7][8], stable_uint2); break;
            case 9 :  write_channel_altera(relS[i & 0x7][9], stable_uint2); break;
            case 10 : write_channel_altera(relS[i & 0x7][10], stable_uint2); break;
            case 11 : write_channel_altera(relS[i & 0x7][11], stable_uint2); break;
            case 12 : write_channel_altera(relS[i & 0x7][12], stable_uint2); break;
            case 13 : write_channel_altera(relS[i & 0x7][13], stable_uint2); break;
            case 14 : write_channel_altera(relS[i & 0x7][14], stable_uint2); break;
            case 15 : write_channel_altera(relS[i & 0x7][15], stable_uint2); break;
        }
      }
...
*/
    ...
    while(true){
      ...
      if(endFlagData == ENDFLAG && !valid_endflag) break; 
    }
    //  probe phrase
    uint matchedCnt = 0; 
    ...
    #pragma unroll 16
      ...
      if(valid_endflag ) endFlagData =  endFlag;
      if(endFlagData == ENDFLAG && !valid_endflag && !valid_s) break; 
    }
