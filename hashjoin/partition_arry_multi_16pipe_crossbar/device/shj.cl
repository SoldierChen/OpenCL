          ...
          #pragma unroll 8
            ...
            engine_finish[i] = valid_r[0] | valid_r[1] | valid_r[2] | valid_r[3] | 
              ...
              if(valid_r[0]){
                ...
                hashtable_l[hash_idx * HASHTABLE_BUCKET_SIZE + hashtable_bucket_cnt[hash_idx][i]][i]= data_r[0];
               ...
               // printf("key %d \n", key);
                ...
                uint val  = data_r[1].y;
                uint hash_idx = HASH (key,(HASHTABLE_BUCKET_NUM - 1),4);
                hashtable_l[hash_idx * HASHTABLE_BUCKET_SIZE + hashtable_bucket_cnt[hash_idx][i]][i]= data_r[1];
                hashtable_bucket_cnt[hash_idx][i] ++; 
               // printf("key %d \n", key);
              }
                ...
                uint val  = data_r[2].y;
                uint hash_idx = HASH (key,(HASHTABLE_BUCKET_NUM - 1),4);
                hashtable_l[hash_idx * HASHTABLE_BUCKET_SIZE + hashtable_bucket_cnt[hash_idx][i]][i]= data_r[2];
                hashtable_bucket_cnt[hash_idx][i] ++; 
               // printf("key %d \n", key);
              }
                ...
                uint val  = data_r[3].y;
                uint hash_idx = HASH (key,(HASHTABLE_BUCKET_NUM - 1),4);
                hashtable_l[hash_idx * HASHTABLE_BUCKET_SIZE + hashtable_bucket_cnt[hash_idx][i]][i]= data_r[3];
                hashtable_bucket_cnt[hash_idx][i] ++; 
               // printf("key %d \n", key);
              }
                ...
                uint val  = data_r[4].y;
                uint hash_idx = HASH (key,(HASHTABLE_BUCKET_NUM - 1),4);
                hashtable_l[hash_idx * HASHTABLE_BUCKET_SIZE + hashtable_bucket_cnt[hash_idx][i]][i]= data_r[4];
                hashtable_bucket_cnt[hash_idx][i] ++; 
               // printf("key %d \n", key);
              }
                ...
                uint val  = data_r[5].y;
                uint hash_idx = HASH (key,(HASHTABLE_BUCKET_NUM - 1),4);
                hashtable_l[hash_idx * HASHTABLE_BUCKET_SIZE + hashtable_bucket_cnt[hash_idx][i]][i]= data_r[5];
                hashtable_bucket_cnt[hash_idx][i] ++; 
               // printf("key %d \n", key);
              }
                ...
                uint val  = data_r[6].y;
                uint hash_idx = HASH (key,(HASHTABLE_BUCKET_NUM - 1),4);
                hashtable_l[hash_idx * HASHTABLE_BUCKET_SIZE + hashtable_bucket_cnt[hash_idx][i]][i]= data_r[6];
                hashtable_bucket_cnt[hash_idx][i] ++; 
               // printf("key %d \n", key);
              }
                ...
                uint val  = data_r[7].y;
                uint hash_idx = HASH (key,(HASHTABLE_BUCKET_NUM - 1),4);
                hashtable_l[hash_idx * HASHTABLE_BUCKET_SIZE + hashtable_bucket_cnt[hash_idx][i]][i]= data_r[7];
                hashtable_bucket_cnt[hash_idx][i] ++; 
               // printf("key %d \n", key);
              }
          /* 
